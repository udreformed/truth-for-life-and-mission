export const supportedLanguages = ["th", "ko", "en"] as const;
...
export const copy = {
  th: {
    ...
    nav: { home: "หน้าหลัก", courses: "หลักสูตร", bibleReading: "อ่านพระคัมภีร์", library: "คลังความรู้", usefulLinks: "เว็บไซต์แนะนำ", search: "ค้นหา", admin: "ผู้ดูแล" },
  ...
  ko: {
    ...
    shortName: "Truth for Life and Mission",
    nav: { home: "홈", courses: "강좌", bibleReading: "성경통독", library: "자료실", usefulLinks: "추천 사이트", search: "검색", admin: "관리자" },
  ...
  en: {
    ...
    shortName: "Truth for Life and Mission",
    nav: { home: "Home", courses: "Courses", bibleReading: "Bible Reading", library: "Library", usefulLinks: "Recommend", search: "Search", admin: "Admin" },
...
export const typeLabels: Record<Language, Record<string, string>> = {
  th: {
    article: "บทความ", book: "หนังสือ", video: "วิดีโอ", pdf: "PDF",
    course: "หลักสูตร", devotional: "เฝ้าเดี่ยว", sermon: "คำเทศนา", sunday_school: "บทเรียนรวีวารศึกษา"
  },
  ko: {
    article: "에세이", book: "도서", video: "영상", pdf: "PDF",
    course: "강좌", devotional: "묵상", sermon: "설교", sunday_school: "주일학교"
  },
  en: {
    article: "Article", book: "Book", video: "Video", pdf: "PDF",
    course: "Course", devotional: "Devotional", sermon: "Sermon", sunday_school: "Sunday School"
  }
};
