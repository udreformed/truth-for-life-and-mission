...
export const deringPrayerIntro = {
...
export const deringPrayerLabels = {
  ko: {
    title: "오늘의 기도",
...
export const deringPrayerSourceUrl = "https://www.monergism.com/godly-private-prayers-householders-meditate-ebook";

export const deringPrayers: DeringPrayer[] = [
  {
    day: 1,
...
export function getDeringPrayerByDay(day: number): DeringPrayer {
  return deringPrayers.find((prayer) => prayer.day === day) ?? deringPrayers[0];
}

export function localizedDeringPrayerTitle(language: Language, prayer: DeringPrayer): string {
  if (language === "th") return prayer.thTitle;
  if (language === "ko") return prayer.koTitle;
  return prayer.sourceTitle;
}

export function localizedDeringPrayerBody(language: Language, prayer: DeringPrayer): string {
