...
var $$SiteLayout = createComponent(($$result, $$props, $$slots) => {
	...
	const { lang, current, title, description } = Astro.props;
	const t = copy[lang];
	...
	return renderTemplate`<html${addAttribute(lang, "lang")}><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="description"${addAttribute(pageDescription, "content")}><meta name="theme-color" content="#173f35"><meta property="og:type" content="website"><meta property="og:title"${addAttribute(pageTitle, "content")}><meta property="og:description"${addAttribute(pageDescription, "content")}><meta property="og:url"${addAttribute(canonical, "content")}><meta property="og:image"${addAttribute(ogImage, "content")}><meta property="og:image:secure_url"${addAttribute(ogImage, "content")}><meta property="og:image:type" content="image/png"><meta property="og:image:width" content="1200"><meta property="og:image:height" content="630"><meta property="og:image:alt"${addAttribute(String(t.siteName), "content")}><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title"${addAttribute(pageTitle, "content")}><meta name="twitter:description"${addAttribute(pageDescription, "content")}><meta name="twitter:image"${addAttribute(ogImage, "content")}><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Chonburi&family=Kanit:wght@400;500;600;700;800&family=Mitr:wght@400;500;600;700&family=Noto+Serif+KR:wght@600;700&family=Playfair+Display:ital,wght@0,600;1,600&family=Sarabun:wght@400;500;600;700&display=swap" rel="stylesheet"><link rel="icon" href="/favicon-20260810.ico" sizes="32x32"><link rel="icon" type="image/png" href="/icon-192-20260810.png" sizes="192x192"><link rel="apple-touch-icon" href="/apple-touch-icon-20260810.png"><link rel="manifest" href="/site-20260810.webmanifest"><link rel="canonical"${addAttribute(canonical, "href")}><title>${pageTitle}</title>${renderHead($$result)}</head><body><a class="skip-link" href="#main">Skip to content</a><header class="site-header"><div class="header-inner"><a${addAttribute({
		brand: true,
		active: current === "home"
	}, "class:list")}${addAttribute(`/${lang}/`, "href")}${addAttribute(String(t.nav.home), "aria-label")}${addAttribute(String(t.nav.home), "title")}><span class="brand-logo-stack"><img class="brand-logo brand-logo-default" src="/site-logo-home-transparent.png" alt="" width="66" height="66" loading="eager"><img class="brand-logo brand-logo-active" src="/site-logo-home-transparent.png" alt="" width="66" height="66" loading="eager"></span></a><nav class="main-nav" aria-label="Main navigation"><a${addAttribute({ active: current === "courses" }, "class:list")}${addAttribute(`/${lang}/courses/`, "href")}>${t.nav.courses}</a><a${addAttribute({
      ...
      (() => {
        ...
        document.addEventListener("click", async (event) => {
          ...
          const shareText = [shareTitle, shareDescription, url].filter(Boolean).join("\\n");
