...
var $$Index = createComponent(async ($$result, $$props, $$slots) => {
	...
	const dateKey = isDateKey(Astro.url.searchParams.get("date")) ? Astro.url.searchParams.get("date") : todayKey;
	...
	const selectedPlan = lang === "ko" && Astro.url.searchParams.get("plan") === "365" ? "365" : "45";
