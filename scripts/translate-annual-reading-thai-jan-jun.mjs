...
const outputUrl = new URL("../work/annual-bible-reading-thai-jan-jun-draft.json", import.meta.url);
const source = JSON.parse(await readFile(sourceUrl, "utf8")).filter((day) => day.month <= 6);
